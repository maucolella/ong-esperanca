export const projetos = [
    {
        id: "voluntariado",
        titulo: "Voluntariado",
        descricao: "Participe das ações sociais, campanhas e atividades realizadas pela ONG Esperança.",
        status: "Vagas abertas",
        detalhes: "Os voluntários apoiam campanhas, organização de doações e atividades com a comunidade."
    },
    {
        id: "doacoes",
        titulo: "Doações",
        descricao: "Contribua com alimentos, roupas ou recursos financeiros para manter os projetos sociais.",
        status: "Recebendo doações",
        detalhes: "As doações são direcionadas às ações sociais e ao atendimento das pessoas beneficiadas."
    },
    {
        id: "campanhas",
        titulo: "Campanhas",
        descricao: "Conheça as campanhas de arrecadação e apoio desenvolvidas ao longo do ano.",
        status: "Em andamento",
        detalhes: "As campanhas reúnem voluntários e doadores em ações de arrecadação e apoio à comunidade."
    }
];
...
export function templateProjetos(interesses = []) {
    const cards = projetos.map(projeto => {
        const selecionado = interesses.includes(projeto.id);
